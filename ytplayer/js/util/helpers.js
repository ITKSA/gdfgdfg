...
$(function() {
    ...
    helpers.getSettingsModal = (onClose) => {
        player.dbQuery('yt_settings', 'ytSettings', (e) => {
            helpers.getModal('settings-modal', 'مشغل اليوتيوب و اعدادات عامة', 'حفظ', $('<form/>').append($('<div/>', {
                'class': 'form-group'
            }).append($('<label/>', {
                'text': 'حجم المشغل الفيديو'
            })).append($('<div/>', {
                'class': 'dropdown'
            }).append($('<button/>', {
